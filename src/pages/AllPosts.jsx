  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-gradient-to-tl from-pink-200/30 to-indigo-200/30 dark:from-pink-900/10 dark:to-indigo-900/10 rounded-full filter blur-3xl opacity-50 animate-float" style={{ animationDelay: '1.2s' }}></div>
        </div>
        ...
        {loading ? (
            ...
            <div className="flex flex-col items-center justify-center min-h-[40vh] p-8 rounded-3xl glass-effect border border-white/10 dark:border-white/5">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
                    There are currently no blog posts available. Check back later for new content!
                </p>
            </div>
        ) : (
            <div className="grid gap-6 sm:gap-8 md:gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
