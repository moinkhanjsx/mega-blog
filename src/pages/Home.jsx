...
function Home() {
    ...
    if (loading) {
        return (
            <section className="flex flex-col justify-center items-center min-h-[60vh] bg-gradient-to-br from-indigo-50 via-pink-50 to-purple-50 rounded-3xl shadow-2xl mx-2 mt-10 p-8 animate-fade-in">
                <Logo />
                <span className="text-2xl text-gray-500 animate-pulse mt-4 font-semibold">Loading latest posts...</span>
            </section>
        )
    }
    if (posts.length === 0) {
        return (
            <section className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-br from-indigo-50 via-pink-50 to-purple-50 rounded-3xl shadow-2xl mx-2 mt-10 p-8 animate-fade-in">
                <Logo />
                ...
                <p className="text-xl text-gray-600 mb-4">{userData ? 'No posts yet. Be the first to create one!' : 'Login to read and create posts.'}</p>
                {!userData && <p className="text-lg text-indigo-600">Sign up or log in to join the conversation.</p>}
    ...
    return (
        <section className="max-w-5xl mx-auto mt-10 bg-gradient-to-br from-indigo-50 via-pink-50 to-purple-50 rounded-3xl shadow-2xl p-8 animate-fade-in">
