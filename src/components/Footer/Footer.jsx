...
function Footer() {
  return (
    <footer className="w-full py-4 sm:py-6 text-center text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 mt-10 flex flex-col items-center gap-2 transition-colors duration-300">
